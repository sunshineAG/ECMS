		...
		<div class="col-margin">
            ...
            <div style="float: left">
                ...
                <a-form-item label="客户经理">
                    <a-select v-model="queryForm.user_id" @change="managerChange"  style="width: 150px;"  placeholder='选择客户经理'>
			...
			<div class="comment_box">
				...
				<div v-if="friendCircleList.length==0?true:false" style="text-align: center;font-size: 14px;position:relative;">
            ...
            getUserList(){
                this.$axios({
                    ...
                    if (udata.status == 1) {
						...
						this.queryForm.user_id = this.managerList[0].id
						this.getWeChat(this.managerList[0].id)
                        this.refreshGroup()
                    }
                })
            },
