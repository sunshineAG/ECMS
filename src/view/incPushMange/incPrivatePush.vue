<template>
	<div class="companyStyle">
		...
		<a-modal :title="taskInfomation.task_name?'详情 - '+taskInfomation.task_name:'未命名'" :visible="mationVisible"  :footer="null" @cancel="com_handleCancel" width="60%" class="infoModal"> 
			<div class="" style="max-height:600px;overflow-y:auto;">
				<div class="lineInfo" >
                    <img src="../../assets/tag.svg"  @error="imgExists($event)" class="iconTag" alt="">
				...
				<div class="mationContextIn" style="padding-top: 0;border:0;">
...
<script>
	...
	export default {
			...
			return {
                ...
                columns1:[
                    ...
                    },
                    {
                        ...
                        align:'center',
                        customRender:record =>{
                            return record.type === "1"?'微信用户':'企业用户'
                        }
                    },
                    {
                        title:'状态',
		...
		methods: {
			...
			new_push() {//新建
				this.$router.push({path:'/pushMange/incNewPush',query:{'pushType':'10','pushTypeInc':'20'}});
            },
            pushUp(bool){
                //重发本页  重发所有
                        let robots = [];
...
<style>
    .incCommon .scrollheade .ant-table-body{
        padding-bottom:60px;
    }
